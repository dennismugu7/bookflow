...
// tests for OwnerBookingInput
void main() {
  final instance = OwnerBookingInputBuilder();
  // TODO add properties to the builder and call build()

  group(OwnerBookingInput, () {
    // String id
    ...
    test('to test the property `teamMemberName`', () async {
      // TODO
    });
    ...
    // String clientEmail
    test('to test the property `clientEmail`', () async {
      // TODO
    });

    // String clientPhone
    test('to test the property `clientPhone`', () async {
      // TODO
    });

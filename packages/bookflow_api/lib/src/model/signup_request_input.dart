...
part 'signup_request_input.g.dart';
...
class _$SignupRequestInputSerializer implements PrimitiveSerializer<SignupRequestInput> {
  ...
  @override
  final String wireName = r'SignupRequestInput';
  ...
  void _deserializeProperties(
    ...
    required SignupRequestInputBuilder result,
  ...
  @override
  SignupRequestInput deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = SignupRequestInputBuilder();

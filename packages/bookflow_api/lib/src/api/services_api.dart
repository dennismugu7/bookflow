...
class ServicesApi {
  ...
  Future<Response<Service>> createService({
    required CreateServiceRequestInput createServiceRequestInput,
    ...
    final _path = r'/v1/me/business/services';
    ...
    try {
      const _type = FullType(CreateServiceRequestInput);
      _bodyData = _serializers.serialize(createServiceRequestInput,
          specifiedType: _type);
  ...
  Future<Response<void>> deleteService({
    ...
    final _path = r'/v1/me/business/services/{serviceId}'.replaceAll(
        '{' r'serviceId' '}',
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<Service>>> listMyServices({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future] containing a [Response] with a [Service] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Service>> updateService({
    required String serviceId,
    required UpdateServiceRequestInput updateServiceRequestInput,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(UpdateServiceRequestInput);
      _bodyData = _serializers.serialize(updateServiceRequestInput,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(

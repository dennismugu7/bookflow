...
class OpeningHoursApi {
  ...
  const OpeningHoursApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<OpeningHoursEntry>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<OpeningHoursEntry>>> getMyOpeningHours({
    ...
    final _path = r'/v1/me/business/opening-hours';
    ...
    BuiltList<OpeningHoursEntry>? _responseData;
    ...
    return Response<BuiltList<OpeningHoursEntry>>(
      data: _responseData,
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltList<OpeningHoursEntry>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<OpeningHoursEntry>>> replaceMyOpeningHours({
    required ReplaceOpeningHoursRequestInput replaceOpeningHoursRequestInput,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(ReplaceOpeningHoursRequestInput);
      _bodyData = _serializers.serialize(replaceOpeningHoursRequestInput,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(

...
class MeApi {
  ...
  Future<Response<void>> deleteMe({
    required DeleteAccountRequestInput deleteAccountRequestInput,
    ...
    try {
      const _type = FullType(DeleteAccountRequestInput);
      _bodyData = _serializers.serialize(deleteAccountRequestInput,
          specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [Profile] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Profile>> updateMe({
    required UpdateProfileRequestInput updateProfileRequestInput,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(UpdateProfileRequestInput);
      _bodyData = _serializers.serialize(updateProfileRequestInput,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(

...
class MediaApi {
  ...
  Future<Response<void>> deletePortfolioImage({
    ...
    final _path = r'/v1/me/business/portfolio-images/{imageId}'.replaceAll(
        '{' r'imageId' '}',
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<PortfolioImage>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<PortfolioImage>>> listMyPortfolioImages({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/v1/me/business/portfolio-images';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    BuiltList<PortfolioImage>? _responseData;
    ...
    return Response<BuiltList<PortfolioImage>>(
      data: _responseData,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [UploadedImage] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UploadedImage>> uploadBusinessImage({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/v1/me/business/images';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(UploadedImage),
            ) as UploadedImage;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,

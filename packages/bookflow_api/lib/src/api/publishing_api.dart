...
class PublishingApi {
  ...
  const PublishingApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [PublishedBusiness] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PublishedBusiness>> publishMyBusiness({
    ...
    final _path = r'/v1/me/business/publish';
    ...
    PublishedBusiness? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(PublishedBusiness),
            ) as PublishedBusiness;
    ...
    return Response<PublishedBusiness>(
      data: _responseData,

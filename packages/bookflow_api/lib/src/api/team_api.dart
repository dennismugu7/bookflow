...
class TeamApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [TeamMember] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TeamMember>> createTeamMember({
    required CreateTeamMemberRequestInput createTeamMemberRequestInput,
    ...
    final _path = r'/v1/me/business/team-members';
    ...
    try {
      const _type = FullType(CreateTeamMemberRequestInput);
      _bodyData = _serializers.serialize(createTeamMemberRequestInput,
          specifiedType: _type);
  ...
  Future<Response<void>> deleteTeamMember({
    ...
    final _path = r'/v1/me/business/team-members/{memberId}'.replaceAll(
        '{' r'memberId' '}',
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<TeamMember>>> listMyTeamMembers({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future] containing a [Response] with a [TeamMember] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TeamMember>> updateTeamMember({
    required String memberId,
    required UpdateTeamMemberRequestInput updateTeamMemberRequestInput,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(UpdateTeamMemberRequestInput);
      _bodyData = _serializers.serialize(updateTeamMemberRequestInput,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(

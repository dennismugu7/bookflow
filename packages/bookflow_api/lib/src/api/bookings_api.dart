...
class BookingsApi {
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [PaymentProof] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PaymentProof>> getBookingPaymentProof({
    required String bookingId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/v1/me/business/bookings/{bookingId}/payment-proof'
        .replaceAll(
            '{' r'bookingId' '}',
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(PaymentProof),
            ) as PaymentProof;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
